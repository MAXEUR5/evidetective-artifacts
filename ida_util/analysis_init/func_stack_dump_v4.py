...
def main():
    ...
    for m in udt:
        if m.name == "__return_address":
            ...
            idc.msg(f"Find RET_ADDR: {ret_addr_offset}\n")
            break
    ...
    # 输出 JSON
    json_filename = f"func_stack_varmatch.json"
    out_data = {
...
#./ida -A -L"output.log" -S"/home/workspace/ida_util/analysis_init/func_stack_dump_v4.py CWE121_Stack_Based_Buffer_Overflow__CWE805_char_alloca_memmove_12_bad" /home/workspace/Testcase/exp1/CWE121_Stack_Based_Buffer_Overflow__CWE805_char_alloca_memmove_12-bad
